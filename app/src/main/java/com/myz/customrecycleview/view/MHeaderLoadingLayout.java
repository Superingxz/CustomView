 ...
 * @since 2013-7-30
 */
public class MHeaderLoadingLayout extends LoadingLayout {
    /** 旋转动画时间 */
     ...
     */
    public MHeaderLoadingLayout(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs attrs
     */
    public MHeaderLoadingLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
